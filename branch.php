        ...
        <form id="branch_form" action="branch.php" method="post">
            <table cellspacing="20%" cellpadding="15%" style="width:100%;border: 1px solid #ddd;border-collapse:collapse;">
                <tr align="center" style="border-bottom:1px solid #ddd">
                    ...
                    <th style="border-right:1px solid #ddd">Branch Name</th>
                    <th style="border-right:1px solid #ddd">Branch Code</th>
                    <th>Action</th>
                </tr>
                <?php
                $q = "SELECT * FROM branch order by branch_id asc";
                $i=1;
                ...
                <tr align="center" style="border-bottom:1px solid #ddd">
                    ...
                    <td>
                        <a id="button1" class="w3-button w3-teal" href="update_branch.php?bid=<?php echo($r[0]) ?>"  style="width:79px">Edit</a><br>
