...
<body>
    ...
    <center>
    <div class="w3-card-4" style="width:90%; margin-top:5%">
        <header class="w3-container w3-teal">
            <h3><b>Student List</b></h3>
        </header>
        <form id="student_form" action="student.php" method="post">
            <table cellspacing="20%" cellpadding="15%" style="width:100%;border: 1px solid #ddd;border-collapse:collapse;">
                <tr align="center" style="border-bottom:1px solid #ddd">
                    ...
                    <th style="border-right:1px solid #ddd">Roll No.</th>
                    <th style="border-right:1px solid #ddd">Branch</th>
                    <th style="border-right:1px solid #ddd">Semester</th>
                    <th style="border-right:1px solid #ddd">Contact No.</th>
                    <th style="border-right:1px solid #ddd">Email</th>
                    <th style="border-right:1px solid #ddd">Address</th>
                    <th>Action</th>
                </tr>
                <?php
                $q = "SELECT * FROM student order by branch asc, semester asc, idstudent asc";
                $i=1;
                ...
                <tr align="center" style="border-bottom:1px solid #ddd">
                    ...
                    <td style="border-right:1px solid #ddd"><?php echo($r[6])?></td>
                    <td style="border-right:1px solid #ddd"><?php echo($r[7])?></td>
                    <td>
                        <a id="button1" class="w3-button w3-teal" href="update_student.php?bid=<?php echo($r[0]) ?>"  style="width:79px">Edit</a><br>
