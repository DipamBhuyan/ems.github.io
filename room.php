...
<body>
    ...
    <center>
    <div class="w3-card-4" style="width:50%; margin-top:5%">
        <header class="w3-container w3-teal">
            <h3><b>Rooms</b></h3>
        </header>
        <form id="room_form" action="room.php" method="post">
            <table cellspacing="20%" cellpadding="15%" style="width:100%;border: 1px solid #ddd;border-collapse:collapse;">
                <tr align="center" style="border-bottom:1px solid #ddd">
                    ...
                    <th style="border-right:1px solid #ddd">Room id</th>
                    <th style="border-right:1px solid #ddd">Room NO.</th>
                    <th>Action</th>
                </tr>
                <?php
                $q = "SELECT * FROM room order by idroom asc";
                $i=1;
                ...
                <tr align="center" style="border-bottom:1px solid #ddd">
                    ...
                    <td>
                        <a id="button1" class="w3-button w3-teal" href="update_room.php?bid=<?php echo($r[0]) ?>"  style="width:79px">Edit</a><br>
