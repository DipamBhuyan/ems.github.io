...
<body>
    ...
    <center>
    <div class="w3-card-4" style="width:80%; margin-top:5%">
        <header class="w3-container w3-teal">
            <h3><b>Faculty List</b></h3>
        </header>
        <form id="faculty_form" action="faculty.php" method="post">
            <table cellspacing="20%" cellpadding="15%" style="width:100%;border: 1px solid #ddd;border-collapse:collapse;">
                <tr align="center" style="border-bottom:1px solid #ddd">
                    ...
                    <th style="border-right:1px solid #ddd">Faculty Name</th>
                    <th style="border-right:1px solid #ddd">branch</th>
                    <th style="border-right:1px solid #ddd">Designation</th>
                    <th style="border-right:1px solid #ddd">Contact No.</th>
                    <th style="border-right:1px solid #ddd">Email</th>
                    <th style="border-right:1px solid #ddd">Photo</th>
                    <th>Action</th>
                </tr>
                <?php
                $q = "SELECT * FROM faculty order by faculty_branch asc";
                $i=1;
                ...
                <tr align="center" style="border-bottom:1px solid #ddd">
                    ...
                    <td style="border-right:1px solid #ddd"><?php echo($r[4])?></td>
                    <td style="border-right:1px solid #ddd"><?php echo($r[5])?></td>
                    <td style="border-right:1px solid #ddd"><img src="faculty_image/<?php echo($r[6])?>" style="height:100px;width:100px;border-radius:50px"></td>
                    <td>
                        <a id="button1" class="w3-button w3-teal" href="update_faculty.php?bid=<?php echo($r[0]) ?>"  style="width:79px">Edit</a><br>
